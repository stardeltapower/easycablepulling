...
class TestTensionCalculations:
    ...
    def test_straight_section_tension(self):
        ...
        assert abs(expected_t_out - 1858.75) < 0.01

    def test_bend_section_tension(self):
        ...
        assert abs(expected_t_out - 1644.72) < 0.01

    def test_sidewall_pressure(self):
...
class TestValidation:
    ...
    def test_minimum_bend_radius_check(self, sample_cable_spec):
